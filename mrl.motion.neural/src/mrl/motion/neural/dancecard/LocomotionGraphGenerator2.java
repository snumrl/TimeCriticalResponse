...
public class LocomotionGraphGenerator2 {
...
//		tEdit.lengthOffset = 0.1;
//		tEdit.timeOffset = 0.05;
...
//			RNNDataGenerator.generate(segment, new DirectionControl(interval));
			...
			String label = folder + "_g_pos_" + interval;
//			String label = folder + "_g_fo2_pos_" + interval;
			RNNDataGenerator.prepareTrainingFolder(label);
