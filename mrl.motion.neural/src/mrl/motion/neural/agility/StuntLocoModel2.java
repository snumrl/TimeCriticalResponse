...
public class StuntLocoModel2 extends AgilityModel {
...
//			{ 0.000, 0.000, 0.000, 0.000 }, // n
	...
	@Override
	public StuntLocoGoal2 sampleIdleGoal() {
		lastGoal = new StuntLocoGoal2(0, 0, GOAL_TIME_LIMIT);
		return lastGoal;
	}
	...
	@Override
	public StuntLocoGoal2 sampleRandomGoal(Pose2d currentPose) {
		int actionType;
		double rotation;
...
//			}
		...
		lastGoal = new StuntLocoGoal2(rotation, actionType, adjustedTime);
	...
	public StuntLocoGoal2 sampleGoal(int actionType) {
		double timeLength = 0;
		timeLength += 8; // base margin
		timeLength += timeOffset[lastGoal.actionType][1];
		timeLength += timeOffset[actionType][0];
	...
	public class StuntLocoGoal2 extends AgilityGoal{
		public double targetRotation;
		
		public StuntLocoGoal2(double targetRotation, int actionType, int timeLimit) {
