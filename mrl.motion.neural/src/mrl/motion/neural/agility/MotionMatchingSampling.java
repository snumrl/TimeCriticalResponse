...
public class MotionMatchingSampling {

	public AgilityModel model;
	public MotionMatching matching;
	...
	public MotionMatchingSampling(MDatabase database, AgilityModel model) {
		this.model = model;
	...
	public ArrayList<Motion> sample(int totalLength) {
		Motion start = matching.getDatabase().getMotionList()[matching.pickRandomStartMotion()];
	...
	private ArrayList<Motion> sample(Motion startMotion, int totalLength) {
		...
		MDatabase db = matching.getDatabase();
...
//		}
	...
	public static class MMControlParameter{
		public int frame;
		public AgilityGoal goal;
		
		public MMControlParameter(int frame, AgilityGoal goal) {
			this.frame = frame;
			this.goal = goal;
		}
	}
