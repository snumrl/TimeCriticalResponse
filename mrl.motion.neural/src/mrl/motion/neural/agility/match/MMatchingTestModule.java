...
public class MMatchingTestModule extends Module {
...
//					RotationGoal goal = new RotationGoal(targetRotation, 23);
					...
					startMotionIndex = matching.tData.database.findMotion("s_001_2_1.bvh", 164).motionIndex;
...
//					listModule.addSingleItem("goal", new Pose2d(new Point2d(), mp2d), ItemDescription.red());
	...
	public static void main(String[] args) {
		MainApplication.run(new MMatchingTestModule());
	}
}
